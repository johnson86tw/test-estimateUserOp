import { concat, Contract, getBytes, Interface, JsonRpcProvider, toBeHex, Wallet, type ContractRunner } from 'ethers'
...
// *********************************************************
const DEMO_ADDRESS = '0x72E6C5D59A5c6e6F58C1539B56f1CAA0f1c18824'
...
const op = await sendop({
	...
	opGetter: {
		...
		async getNonce() {
			const nonceKey = concat(['0x00000000', '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266'])
