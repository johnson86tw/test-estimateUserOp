...
contract Demo3Test is Test {
    ...
    function test_validateUserOp() public {
        ...
        PackedUserOperation memory userOp =
            _buildUserOp(privateKey, address(demo3), abi.encodeCall(demo3.setCaller, ()));
        _handleUserOp(userOp);

        assertEq(demo3.caller(), address(signer));
    }
        ...
        returns (PackedUserOperation memory)
    {
        ...
        address signerAddress = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
        userOp.nonce = entryPoint.getNonce(sender, uint192(uint160(signerAddress)));
